    ...
    <div className="pl-[94px] pr-6 py-[18px] flex justify-between items-center bg-[#fff] shadow-sm fixed top-0 right-0 left-0 z-10">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className='flex gap-2 items-center'>
            <div className='w-[38px] h-[38px] rounded-full bg-[#CFD4ED] flex justify-center items-center text-[#151515] text-base font-bold'>I</div>
            <p className='text-[#151515] text-sm'>Ilham Firmansyah</p>
