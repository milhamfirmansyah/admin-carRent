...
function Navbar({search, onclick}: any) {
      ...
      <div className="flex items-center gap-6">
        <div className="flex">
          <div className="relative">
            <input onChange={search} type="search" placeholder="search" className="pl-[38px] pr-3 h-[36px] border placeholder:w-[124px] placeholder:text-xs outline-none" />
            <MagnifyingGlassIcon className="w-[18px] h-[18px] text-[#D0D0D0] absolute top-[9px] left-3 cursor-text" />
          </div>
          <button onClick={onclick} className="border w-[61px] h-[36px] text-sm font-bold text-[#0D28A6] rounded-sm border border-[#0D28A6]">Search</button>
        </div>
