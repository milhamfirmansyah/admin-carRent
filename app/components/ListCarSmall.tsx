...
function ListCarSmall() {
  ...
  const getData = async () => {
    const res = await axios.get(`https://api-car-rental.binaracademy.org/admin/v2/car?category=small&name=${search}`, {
      headers: {
    ...
    <Navbar search={handleSearch} onclick={getData}/>
      <div className="pt-[102px] pl-[245px] pr-[25px]">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <button className="border border-[#0D28A6] py-2 px-3 rounded-sm text-[#0D28A6] text-sm font-bold bg-[#CFD4ED]">2 - 4 people</button>
