...
function Sidebar() {
  return (
    <div className="w-[70px] h-[902px] bg-[#0D28A6] flex flex-col items-center fixed z-10">
      ...
      <div className="flex flex-col items-center py-[20px] cursor-pointer hover:bg-[#FFF] hover:bg-opacity-30 w-full">
        ...
        <p className="text-[#FFF] text-[12px] font-sans font-bold leading-[18px]">Dashboard</p>
      </div>
      <div className="flex flex-col items-center py-[20px] cursor-pointer hover:bg-[#FFF] hover:bg-opacity-30 w-full">
        <TruckIcon className="h-[24px] w-[24px] text-[#FFFFFF]" />
        <p className="text-[#FFF] text-[12px] font-sans font-bold leading-[18px]">Cars</p>
      </div>
    </div>
  );
}
